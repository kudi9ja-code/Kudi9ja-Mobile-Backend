 ...
 *       endpoint that could — a reminder goes to the borrower's own
...
public class AdminLoanService {
     ...
     *
     * <p>Refused outside 8am–8pm Lagos time. The window is a promise the
     ...
     * exactly as it stands — writing a loan off says the company will not chase
